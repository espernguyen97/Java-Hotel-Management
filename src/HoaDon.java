...
public class HoaDon {
	...
	public void nhap(Scanner scan) {
		...
		System.out.print("Nhập tháng của hóa đơn: ");
		this.thangHD = Integer.parseInt(scan.nextLine());
		System.out.print("Nhập năm của hóa đơn: ");
	...
	public void xuat() {
		System.out.print("Mã hóa đơn: " + this.maHD + "\t Ngày : " + this.ngayHD + "\t Tháng: " + this.thangHD
				+ "\t Năm: " + this.namHD + "\t Tên Khách Hàng: " + this.tenKH + "\t Mã phòng: " + this.maPhong);
	}
